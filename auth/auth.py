...
from auth0 import auth0_config
...
class AuthError(Exception):
 ...
 # ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ #
 # PLEASE NOTE THAT I HAVE DIRECTLY COPIED THIS AUTH.PY FILE FROM MY COFFEESHOP PROJECT (LINK-https://github.com/SreeramVipparla/Coffee_shop_full_stack/tree/master/backend/src/auth)
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- #
